...
import GooglePlaces
@MainActor
class BusinessRegistrationViewModel: ObservableObject {
    ...
    @Published var businessDetails : OwnerDetails?
    ...
    func removeDoc(at index: Int) {
        selectedDocImages.remove(at: index)
    }
    ...
    func getYourBusinessDetailApi() {
        ...
        APIManager.shared.getYourBusinessDetailApi()
            .sink { completionn in
                ...
                if response.success  ?? false {
                    ...
                    self.providerName = response.data?.name ?? ""
